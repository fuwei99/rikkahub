...
import me.rerere.rikkahub.ui.pages.extensions.packages.ToolPackagesPage
                ...
                Box(
                    ...
                    NavDisplay(
                        ...
                        entryProvider = entryProvider {
                            ...
                            entry<Screen.GlobalMemoryGraph> {
                            ...
                            entry<Screen.SettingPreferencesFile> {
                                SettingPreferencesFilePage()
                            }
                            ...
                            entry<Screen.SettingCommunication> {
                                SettingCommunicationPage()
                            }

                            entry<Screen.SettingSupervision> {
...
sealed interface Screen : NavKey {
    ...
    @Serializable
    data object SettingPreferencesFile : Screen
    ...
    @Serializable
    data object LogSettings : Screen
    ...
    @Serializable
    data object SettingCommunication : Screen
    ...
    @Serializable
    data object ToolPackages : Screen
