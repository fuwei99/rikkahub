...
class BackupVM(
    ...
    val syncLastSyncedAt = syncEngine.lastSyncedAt
    ...
    /** 只上传本地改动 */
    suspend fun cloudPushNow() = syncEngine.pushOnly(force = true)

    /** 只拉取云端变更 */
    suspend fun cloudPullNow() = syncEngine.pullOnly(force = true)
